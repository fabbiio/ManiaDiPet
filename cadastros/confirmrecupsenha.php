...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: INSTRUCOES ENVIADAS</title>
</head>
...
<div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <p>
                    As instruções para a realização de cadastro de uma nova senha foram enviadas para o e-mail <b><?php echo $_SESSION['confirma']; ?></b>. Abra a mensagem que lhe enviamos e siga as instruções corretamente para cadastrar uma nova senha.
                </p>
                <p>
                ...
                <p>
                    Cordialmente,<br>
                    Central de Relacionamento MundoDiPet
                </p>
                <p>

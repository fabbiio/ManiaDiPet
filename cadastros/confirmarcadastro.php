...
$sql = "SELECT * FROM paginacao";
    ...
    if(!isset($_SESSION["email"])){
        header("Location: cadastro_usuario.php?erro");
...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: NOVO USUARIO</title>
</head>
    ...
    <div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <hr>
                <p>
                    Caro <b><?php echo $_SESSION["nome"]?></b>,
                </p>
                <p>
                    
                    Obrigado por se cadastrar em nossa loja virtual. Um e-mail de confirmação foi enviado para o <b><?php echo $_SESSION["email"]?></b>. Clique no link de confirmação presente no e-mail para concluirmos seu cadastro.
                </p>
                <p>
                ...
                <p>
                    Cordialmente,<br>
                    Central de Relacionamento ManiaDiPet
                </p>
                <p>

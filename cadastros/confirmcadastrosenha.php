...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: NOVO SENHA CADASTRADA</title>
</head>
    ...
    <div class="d-flex flex-column wrapper">
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <p>
                    Sua nova senha foi cadastrada com sucesso. Para entrar em sua área restrita agora mesmo, <a href="../usuario/login.php">clique aqui</a>.
                </p>
                <p>
                ...
                <p>
                    <a href="index.html" class="btn btn-lg btn-danger">Voltar à Página Principal</a>
                </p>
            </div>
        </main>

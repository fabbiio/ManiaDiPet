...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: RECUPERAR ACESSO</title>
</head>
        ...
        <main class="flex-fill">
            <div class="container">
                <div class="row justify-content-center">
                    <form class="col-sm-10 col-md-8 col-lg-6" method="POST" action="config/recuperar_senha.php">
                        <h1>Recuperação de Senha</h1>
                        <?php 
                        if(isset($_SESSION['erro'])){
                            echo "<div class='alert alert-alert' role='alert'> Email não Cadastrado </div>" ;
                            unset($_SESSION['erro']);
                        }    ?>
                        ...
                        <p class="mt-3">
                            Ainda não é cadastrado? <a href="cadastro_usuario.php">Clique aqui</a> para se cadastrar.
                        </p>
                    </form>
                </div>
            </div>

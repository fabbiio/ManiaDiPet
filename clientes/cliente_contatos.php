...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: CONTATOS</title>
</head>
            ...
            <div class="container">
                ...
                <div class="row gx-3">
                    ...
                    <div class="list-group">
                            ...
                            <a href="cliente_contatos.php" class="list-group-item list-group-item-action bg-primary text-light">
                    ...
                    <div class="col-8">
                        ...
                        <?php
                            ...
                            <div class="form-floating mb-3 col-md-8">
                                <input class="form-control" type="email" id="txtEmail" placeholder=" " value="<?php echo $user_data['email']; ?>" disabled/>
                                <label for="txtEmail">E-mail</label>
                            </div>
                            <div class="form-floating mb-3 col-md-6">
                                <input class="form-control" type="text" id="txtTelefone" placeholder=" " value="<?php echo $user_data['telefone']; ?>" disabled />

...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: DADOS PESSOAIS</title>
</head>
            ...
            <div class="container">
                ...
                <div class="row gx-3">
                    ...
                    <div class="list-group">
                            ...
                            <a href="cliente_dados.php" class="list-group-item list-group-item-action bg-primary text-light">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-floating mb-3">
                            <input class="form-control" type="text" id="txtNome" placeholder=" " autofocus value="<?php echo $user_data['nome']; ?>" disabled/>
                            <label for="txtNome">Nome</label>
                        </div>
                        <div class="form-floating mb-3 col-md-6 col-xl-4">
                            <input class="form-control" type="text" id="txtCPF" placeholder=" " value="<?php echo $user_data['cpf']; ?>"  disabled/>
                            <label for="txtCPF">CPF</label>
                        </div>
                        <div class="form-floating mb-3 col-md-6 col-xl-4">
                            <input class="form-control" type="date" id="txtDataNascimento" name="data_nascimento" placeholder=" " value="<?php echo $dataFormatada; ?>" disabled />

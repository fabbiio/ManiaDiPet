...
$sql = " SELECT 
    ...
    favoritos.id as id_favorito
    FROM 
    favoritos 
    INNER JOIN 
    produtos ON 
    favoritos.id_produto = produtos.id 
...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: FAVORITOS</title>
</head>
            ...
            <div class="container">
                ...
                <div class="row gx-3 mb-3">
                    ...
                    <div class="list-group">
                            ...
                            <a href="cliente_favoritos.php" class="list-group-item list-group-item-action bg-primary text-light">
                        ...
                        if (isset($_SESSION['delete'])) {
                            echo "<div class='alert alert-danger' role='alert'> Produto Excluido do Carrinho </div>";
                    ...
                    <div class="col-8">
                        ...
                        <div class="row g-3">
                        <?php while ($user_data = mysqli_fetch_assoc($produtos)){ 
                            ...
                            <div class="card text-center bg-light h-100 d-flex flex-column">
                                    <a href="config/excluir_favorito.php?id=<?php echo  $user_data['id_favorito']?>" class="position-absolute end-0 p-2 text-danger" title="Remover dos favoritos">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-lg" viewBox="0 0 16 16">
                                            <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8z"/>
                                        </svg>
                                    </a>
                                    <img src="../img/produtos/<?php echo $user_data['imagem'] ?>" class="card-img-top">
                                    <div class="card-header">
                                    <?php echo $user_data['valor'] ?>
                                    </div>
                                    <div class="card-body">
                                    ...
                                    <div class="card-footer">
                                        <a href="../checkout/config/adiciona_carrinho.php?id=<?php echo $user_data['id_produto'] ?>" class="btn btn-danger mt-2 d-block">
                                            Adicionar ao Carrinho
                                        </a>
                                        <small class="text-success"><?php echo $user_data['quantidade'] ?> und. Disponiveis</small>
                                    </div>
                                  </div>
                            </div>
                            <?php } ; ?>

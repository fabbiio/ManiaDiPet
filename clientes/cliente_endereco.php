...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: MEU ENDEREÇO</title>
</head>
            ...
            <div class="container">
                ...
                <div class="row gx-3">
                    ...
                    <div class="list-group">
                            ...
                            <a href="cliente_endereco.php" class="list-group-item list-group-item-action bg-primary text-light">
                    ...
                    <div class="col-8">
                        ...
                        <?php
                            ...
                            <div class="form-floating mb-3 col-md-6 col-lg-4">
                                <input class="form-control" type="text" id="txtCEP" placeholder=" " autofocus value="<?php echo $user_data['cep']; ?>" required disabled />
                                <label for="txtCEP">CEP</label>
                            </div>
                            <div class="form-floating mb-3 col-md-6 col-lg-4">
                                <input class="form-control" type="text" id="txtEndereco" placeholder=" " autofocus value="<?php echo $user_data['rua']; ?>" required disabled/>
                                <label for="txtCEP">Endereço</label>
                            </div>
                            <div class="form-floating mb-3 col-md-4">
                                <input class="form-control" type="text" id="txtNumero" placeholder=" " autofocus value="<?php echo $user_data['numero']; ?>" required disabled />
                                <label for="txtNumero">Número</label>
                            </div>
                            <div class="form-floating mb-3 col-md-8">
                                <input class="form-control" type="text" id="txtComplemento" placeholder=" " autofocus value="<?php echo $user_data['complemento']; ?>" required disabled/>
                                <label for="txtComplemento">Complemento</label>
                            </div>
                            <div class="form-floating mb-3">
                                <input class="form-control" type="text" id="txtReferencia" placeholder=" " autofocus value="<?php echo $user_data['referencia']; ?>" required disabled/>

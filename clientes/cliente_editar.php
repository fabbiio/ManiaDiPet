...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: EDITAR MEUS DADOS</title>
</head>
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <div class="row gx-3">
                    ...
                    <div class="list-group">
                            <a href="cliente_editar.php" class="list-group-item list-group-item-action bg-primary text-light">
            ...
            <div class="container">
                ...
                if (isset($_SESSION['erro'])) {
                    echo "<div class='alert alert-success' role='alert'>Cadastro Atualizado </div>";
                    unset($_SESSION['erro']);
                } ?>
                
                <form class="mt-3" id="formularioSenha" method="POST" action="config/atualizar_usuario.php">
                <?php
                            $sql = "SELECT * FROM usuario WHERE id = $id_usuario ";
                            $usuario = $conn->query($sql);
                            while ($user_data = mysqli_fetch_assoc($usuario)){ 
                                $data = $user_data['data_nascimento'];
                                $date = new DateTime($data); 
                                $dataFormatada = $date->format('Y-m-d'); // Formato YYYY-MM-DD
                                ?> 
                    <div class="row">
                        <div class="col-sm-12 col-md-6">
                            ...
                            <input type="hidden" name="id" value="<?php echo $user_data['id'];?>">
                                <div class="form-floating mb-3">
                                    <input class="form-control" type="text" id="nome" name="nome" autofocus value="<?php echo $user_data['nome']; ?>"/>
                                    <label for="txtNome">Nome</label>
                                </div>
                                <div class="form-floating mb-3 col-md-6 col-xl-5">
                                    <input class="form-control" type="number" id="cpf" name="cpf" maxlength="11"
                                        required pattern="\d{11}" value="<?php echo $user_data['cpf']; ?>" disabled/>
                                    <input type="hidden" name="cpf" value="<?php echo $user_data['cpf'];?>">
                                    <label for="txtCPF">CPF</label>
                                </div>
                                <div class="form-floating mb-3 col-md-6 col-xl-5">
                                <input class="form-control" type="date" id="txtDataNascimento" name="data_nascimento" placeholder=" " value="<?php echo $dataFormatada; ?>"  />
                            ...
                            <fieldset>
                                ...
                                <div class="form-floating mb-3 col-md-8">
                                    <input class="form-control" type="email" name="email" placeholder=" " value="<?php echo $user_data['email']; ?>" disabled autofocus />
                                    <input type="hidden" name="email" value="<?php echo $user_data['email'];?>">
                                    <label for="txtEmail">E-mail</label>
                                </div>
                                <div class="form-floating mb-3 col-md-6">
                                    <input class="form-control" placeholder=" " type="tel" name="telefone" value="<?php echo $user_data['telefone'];?>" required
                                        autofocus />
                        ...
                        <div class="col-sm-12 col-md-6">
                            <fieldset class="row gx-3">
                                ...
                                <div class="form-floating mb-3 col-md-6 col-lg-4">
                                    <input class="form-control" id="cep" name="cep" maxlength="9" onblur="consultaCEP()" value="<?php echo $user_data['cep'];?>" required  />
                                    <label for="cep">CEP</label>
                                </div>
                                <div class="form-floating mb-3 col-md-6 col-lg-4">
                                    <input class="form-control" type="text" id="cidade" name="cidade" value="<?php echo $user_data['cidade'];?>"readonly />
                                    <label for="cidade">Cidade</label>
                                </div>
                                <div class="form-floating mb-3 col-md-4 col-lg-3">
                                    <input class="form-control" type="text" id="estado" name="estado" value="<?php echo $user_data['estado'];?>"readonly />
                                    <label for="estado">Estado</label>
                                </div>
                                <div class="form-floating mb-3 col-md-8 col-lg-8">
                                    <input class="form-control" type="text" name="rua" id="logradouro" required value="<?php echo $user_data['rua'];?>"autofocus />
                                    <label for="logradouro">Rua</label>
                                </div>
                                <div class="form-floating mb-3 col-md-4 col-lg-3">
                                    <input class="form-control" type="number" name="numero" placeholder=" " required value="<?php echo $user_data['numero'];?>" />
                                    <label for="">Número</label>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-floating mb-3 col-md-4">
                                    <input class="form-control" type="text" name="bairro" id="bairro" required value="<?php echo $user_data['bairro'];?>" />
                                    <label for="bairro">Bairro</label>
                                </div>
                                <div class="form-floating mb-3 col-md-8">
                                    <input class="form-control" type="text" name="complemento" placeholder=" " value="<?php echo $user_data['complemento'];?>"/>
                                    <label for="complemento">Complemento</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input class="form-control" type="text" name="referencia" placeholder=" " value="<?php echo $user_data['referencia'];?>"/>
                    ...
                    <div class="mb-3 text-left">
                        ...
                        <button type="submit" class="btn btn-lg btn-danger">Atualizar</button>

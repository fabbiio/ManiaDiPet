        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <div class="text-end border border-top-0 rounded-bottom p-4 pb-0">
                    <a href="fechamento_endereco.php" class="btn btn-success btn-lg mb-4">
                        Voltar aos Endereços
                    </a>
                    <a href="config/salvar_pedido.php?fafc=1" class="btn btn-danger btn-lg ms-2 mb-4">Finalizar</a>
                </div>
            </div>
        </main>

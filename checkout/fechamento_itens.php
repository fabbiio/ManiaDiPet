                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-8 col-md-9 col-lg-7 col-xl-8 text-left align-self-center">
                                ...
                                <?php echo $dados['descricao'];?>
                                    <br>
                                    <b>
                                    <?php echo $dados['quantidade'];?> und.<br>
                                        
                                        R$ <?php echo $valor_pedido;?><br>
                                    </b>
                                </h5>
                            </div>                            
                        </div>
                    ...
                    <li class="list-group-item pt-3 pb-0">
                        <div class="text-end">
                            <h4 class="text-dark mb-3">
                                Valor Total: <?php echo $valor_total ; ?>
                            </h4>
                            <a href="carrinho.php" class="btn btn-success btn-lg mb-3">
                                Voltar ao Carrinho
                            </a>
                            <a href="fechamento_endereco.php" class="btn btn-danger btn-lg ms-2 mb-3">Continuar</a>
                        </div>
                    </li>
                </ul>
            </div>

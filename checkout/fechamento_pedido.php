    ...
    <nav class="navbar navbar-expand-lg navbar-dark border-bottom shadow-sm mb-3" style="background-color: <?php echo $_SESSION['cor']?>;" >
        ...
        <main class="flex-fill">
            <div class="container text-center">
                ...
                <p>Em até 2 dias, seu pedido será entregue. Qualquer dúvida sobre este pedido, entre em contato conosco e informe o número do pedido para que possamos te ajudar.</p>
                ...
                <p>
                    <a href="../index.php" class="btn btn-danger btn-lg">Voltar à Página Principal</a>
                </p>
            </div>
        </main>

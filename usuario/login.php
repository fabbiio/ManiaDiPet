...
if (isset($_SESSION['usuario'])) { // Fechar a sessão 
...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: LOGIN</title>
</head>
<body>
            ...
            <div class="container">
                ...
                <?php 
                        if(isset($_SESSION['add'])){
                            echo "<div class='alert alert-danger' role='alert'> Senha ou Emal Incorretos </div>" ;
                            unset($_SESSION['add']);
                        }
                        if(isset($_SESSION['nn'])){
                            echo "<div class='alert alert-danger' role='alert'> Email não cadastrado</div>" ;
                            unset($_SESSION['nn']);
                        }  
                        
                        ?>    
                    <form class="col-sm-10 col-md-8 col-lg-6" method="POST" action="config/verifica_login.php" onsubmit="hashPassword()">
    ...
    <script>
        function hashPassword() { 
            ...
            var hashedSenha = CryptoJS.SHA256(senhaField.value); 
            senhaField.value = hashedSenha; 
            }
    </script>
</body>

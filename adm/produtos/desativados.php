...
$sql = "SELECT * FROM produtos WHERE status = 'desativado'";
...
<head>
    ...
    <title>Portal Administrador :: Produtos Em Analise</title>
    <!-- Bootstrap CSS -->
        ...
        <div id="content">
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand" href="#">Produtos Desativados </a>
            ...
            <div class="card" style="min-height: 485px">
                <div class="card-header card-header-text">
                    <h3 class="card-title">Produtos Desativados</h3>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editForm" method="POST" action="config/atualiza_produtos.php?des">

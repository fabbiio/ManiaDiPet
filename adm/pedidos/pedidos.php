    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="dropdown ">
                    <a href="../usuarios/exibir.php" class="">
            ...
            <div class="top-navbar">
                <nav class="navbar navbar-expand-lg">
                    <div class="container-fluid">
                        ...
                        <a class="navbar-brand" href="#">Listar Pedidos </a>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm" data-product-id="" onclick="showDeleteModal(this)">

...
<head>
    ...
    <title><?php echo $_SESSION['titulo']  ?> :: CONTATO </title>
</head>
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark border-bottom shadow-sm mb-3" style="background-color: <?php echo $_SESSION['cor']?>;" >
        ...
        <main class="flex-fill">
            <div class="container">
                ...
                <form class="col-sm-10 col-md-8 col-lg-6" method="POST" action="config/salvar_contato.php">
                        <h1>Entre em Contato</h1>

                        <div class="form-floating mb-3">
                            <input type="text" id="txtNomeCompleto" class="form-control" placeholder=" " autofocus name="nome">
                        ...
                        <div class="form-floating mb-3">
                            <textarea id="txtMensagem" class="form-control" placeholder=" " style="height: 200px;" name="mensagem"></textarea>
